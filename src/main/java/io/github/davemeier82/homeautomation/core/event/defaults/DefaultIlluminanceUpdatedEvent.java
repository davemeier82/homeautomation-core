...
public class DefaultIlluminanceUpdatedEvent extends AbstractDevicePropertyEvent<Integer> implements IlluminanceUpdatedEvent {

  public DefaultIlluminanceUpdatedEvent(DevicePropertyId devicePropertyId,
                                        String displayName,
