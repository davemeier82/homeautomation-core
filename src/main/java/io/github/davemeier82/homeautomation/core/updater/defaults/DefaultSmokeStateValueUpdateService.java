...
public class DefaultSmokeStateValueUpdateService extends AbstractValueUpdateService<Boolean> implements SmokeStateValueUpdateService {

  private final EventFactory eventFactory;

  public DefaultSmokeStateValueUpdateService(DevicePropertyValueRepository devicePropertyValueRepository,
  ...
  protected DevicePropertyType getDevicePropertyType() {
    return DefaultDevicePropertyType.SMOKE_SENSOR;
  }
  ...
  protected DevicePropertyEvent<Boolean> createUpdatedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Boolean> newValue, DataWithTimestamp<Boolean> previousValue, String displayName) {
    return eventFactory.createSmokeStateUpdatedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
  ...
  protected DevicePropertyEvent<Boolean> createChangedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Boolean> newValue, DataWithTimestamp<Boolean> previousValue, String displayName) {
    return eventFactory.createSmokeStateChangedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
