...
public class DefaultMotionStateValueUpdateService extends AbstractValueUpdateService<Boolean> implements MotionStateValueUpdateService {

  private final EventFactory eventFactory;

  public DefaultMotionStateValueUpdateService(DevicePropertyValueRepository devicePropertyValueRepository,
  ...
  protected DevicePropertyType getDevicePropertyType() {
    return DefaultDevicePropertyType.MOTION_SENSOR;
  }
  ...
  protected DevicePropertyEvent<Boolean> createUpdatedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Boolean> newValue, DataWithTimestamp<Boolean> previousValue, String displayName) {
    return eventFactory.createMotionUpdatedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
  ...
  protected DevicePropertyEvent<Boolean> createChangedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Boolean> newValue, DataWithTimestamp<Boolean> previousValue, String displayName) {
    return eventFactory.createMotionChangedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
