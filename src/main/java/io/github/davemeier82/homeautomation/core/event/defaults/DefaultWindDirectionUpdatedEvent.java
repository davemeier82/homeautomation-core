...
public class DefaultWindDirectionUpdatedEvent extends AbstractDevicePropertyEvent<Float> implements WindDirectionUpdatedEvent {

  public DefaultWindDirectionUpdatedEvent(DevicePropertyId devicePropertyId,
                                          String displayName,
