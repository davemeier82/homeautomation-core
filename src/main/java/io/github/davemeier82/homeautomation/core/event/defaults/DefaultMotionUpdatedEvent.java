...
public class DefaultMotionUpdatedEvent extends AbstractDevicePropertyEvent<Boolean> implements MotionUpdatedEvent {

  public DefaultMotionUpdatedEvent(DevicePropertyId devicePropertyId,
                                   String displayName,
