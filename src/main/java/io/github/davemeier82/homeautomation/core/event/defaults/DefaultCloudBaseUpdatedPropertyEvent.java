 ...
 * @since 0.4.0
 */
public class DefaultCloudBaseUpdatedPropertyEvent extends DevicePropertyEventBase<CloudBaseSensor> implements CloudBaseUpdatedEvent {
   ...
   */
  public DefaultCloudBaseUpdatedPropertyEvent(CloudBaseSensor sensor,
