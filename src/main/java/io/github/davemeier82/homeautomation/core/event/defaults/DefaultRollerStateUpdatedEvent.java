...
public class DefaultRollerStateUpdatedEvent extends AbstractDevicePropertyEvent<RollerState> implements RollerStateUpdatedEvent {

  public DefaultRollerStateUpdatedEvent(DevicePropertyId devicePropertyId,
                                        String displayName,
