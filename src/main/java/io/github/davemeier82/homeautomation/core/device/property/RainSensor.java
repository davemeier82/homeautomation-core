...
/**
 * A Sensor that reports the rain.
 *
 * @author David Meier
 * @since 0.4.0
 */
public interface RainSensor extends DeviceProperty {
   ...
   *
   * @return Optional.empty() if the rain rate unknown
   */
  Optional<DataWithTimestamp<Float>> getRateInMmph();

  /**
   * Returns the rain amount in millimeter for the interval defined in the sensor at the time of the measurement.
   *
   * @return Optional.empty() if the r is unknown
   */
  Optional<DataWithTimestamp<Float>> getIntervalMm();
