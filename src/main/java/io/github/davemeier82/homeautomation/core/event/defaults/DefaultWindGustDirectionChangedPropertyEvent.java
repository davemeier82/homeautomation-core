 ...
 * @since 0.4.0
 */
public class DefaultWindGustDirectionChangedPropertyEvent implements DevicePropertyEvent, WindGustDirectionChangedEvent {
   ...
   */
  public DefaultWindGustDirectionChangedPropertyEvent(DevicePropertyId devicePropertyId,
