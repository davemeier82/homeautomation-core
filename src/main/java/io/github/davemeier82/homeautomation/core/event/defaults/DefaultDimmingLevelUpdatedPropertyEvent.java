 ...
 * @since 0.1.0
 */
public class DefaultDimmingLevelUpdatedPropertyEvent implements DevicePropertyEvent, DimmingLevelUpdatedEvent {
   ...
   */
  public DefaultDimmingLevelUpdatedPropertyEvent(DevicePropertyId devicePropertyId,
