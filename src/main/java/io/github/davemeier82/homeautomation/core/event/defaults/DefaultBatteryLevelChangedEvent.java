...
public class DefaultBatteryLevelChangedEvent extends AbstractDevicePropertyEvent<Integer> implements BatteryLevelChangedEvent {

  public DefaultBatteryLevelChangedEvent(DevicePropertyId devicePropertyId,
                                         String displayName,
