...
public class DefaultRainRateChangedEvent extends AbstractDevicePropertyEvent<Float> implements RainRateChangedEvent {

  public DefaultRainRateChangedEvent(DevicePropertyId devicePropertyId,
                                     String displayName,
