...
public class DefaultDimmingLevelUpdatedEvent extends AbstractDevicePropertyEvent<Integer> implements DimmingLevelUpdatedEvent {

  public DefaultDimmingLevelUpdatedEvent(DevicePropertyId devicePropertyId,
                                         String displayName,
