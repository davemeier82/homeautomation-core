 ...
 * @since 0.1.0
 */
public class DefaultWindowStateChangedPropertyEvent implements DevicePropertyEvent, WindowStateChangedEvent {
   ...
   */
  public DefaultWindowStateChangedPropertyEvent(DevicePropertyId devicePropertyId,
                                                String displayName,
