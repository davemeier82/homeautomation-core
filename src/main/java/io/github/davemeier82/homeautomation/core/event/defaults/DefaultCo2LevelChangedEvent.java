...
public class DefaultCo2LevelChangedEvent extends AbstractDevicePropertyEvent<Integer> implements Co2LevelChangedEvent {

  public DefaultCo2LevelChangedEvent(DevicePropertyId devicePropertyId,
                                     String displayName,
