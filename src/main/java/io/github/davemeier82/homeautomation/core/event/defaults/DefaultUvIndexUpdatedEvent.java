...
public class DefaultUvIndexUpdatedEvent extends AbstractDevicePropertyEvent<Float> implements UvIndexUpdatedEvent {

  public DefaultUvIndexUpdatedEvent(DevicePropertyId devicePropertyId,
                                    String displayName,
