...
public class DefaultHumidityValueUpdateService extends AbstractValueUpdateService<Float> implements HumidityValueUpdateService {

  private final EventFactory eventFactory;

  public DefaultHumidityValueUpdateService(DevicePropertyValueRepository devicePropertyValueRepository,
  ...
  protected DevicePropertyEvent<Float> createUpdatedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Float> newValue, DataWithTimestamp<Float> previousValue, String displayName) {
    return eventFactory.createHumidityUpdatedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
