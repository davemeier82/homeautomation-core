 ...
 * @since 0.1.0
 */
public class DefaultMotionUpdatedPropertyEvent implements DevicePropertyEvent, MotionUpdatedEvent {
   ...
   */
  public DefaultMotionUpdatedPropertyEvent(DevicePropertyId devicePropertyId,
                                           String displayName,
