...
public class DefaultPressureChangedEvent extends AbstractDevicePropertyEvent<Float> implements PressureChangedEvent {

  public DefaultPressureChangedEvent(DevicePropertyId devicePropertyId,
                                     String displayName,
