...
public class DefaultWindSpeedChangedEvent extends AbstractDevicePropertyEvent<Float> implements WindSpeedChangedEvent {

  public DefaultWindSpeedChangedEvent(DevicePropertyId devicePropertyId,
                                      String displayName,
