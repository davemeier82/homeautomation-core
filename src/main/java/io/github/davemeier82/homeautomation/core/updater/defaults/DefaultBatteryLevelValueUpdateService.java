...
public class DefaultBatteryLevelValueUpdateService extends AbstractValueUpdateService<Integer> implements BatteryLevelUpdateService {

  private final EventFactory eventFactory;

  public DefaultBatteryLevelValueUpdateService(DevicePropertyValueRepository devicePropertyValueRepository,
  ...
  protected DevicePropertyEvent<Integer> createUpdatedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Integer> newValue, DataWithTimestamp<Integer> previousValue, String displayName) {
    return eventFactory.createBatteryLevelUpdatedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
  ...
  protected DevicePropertyEvent<Integer> createChangedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Integer> newValue, DataWithTimestamp<Integer> previousValue, String displayName) {
    return eventFactory.createBatteryLevelChangedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
