...
public class DefaultUvIndexValueUpdateService extends AbstractValueUpdateService<Float> implements UvIndexValueUpdateService {

  private final EventFactory eventFactory;

  public DefaultUvIndexValueUpdateService(DevicePropertyValueRepository devicePropertyValueRepository,
  ...
  protected DevicePropertyEvent<Float> createUpdatedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Float> newValue, DataWithTimestamp<Float> previousValue, String displayName) {
    return eventFactory.createUvIndexUpdatedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
  ...
  protected DevicePropertyEvent<Float> createChangedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Float> newValue, DataWithTimestamp<Float> previousValue, String displayName) {
    return eventFactory.createUvIndexChangedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
