...
public class DefaultCloudBaseUpdatedEvent extends AbstractDevicePropertyEvent<Float> implements CloudBaseUpdatedEvent {

  public DefaultCloudBaseUpdatedEvent(DevicePropertyId devicePropertyId,
                                      String displayName,
