 ...
 * @since 0.4.0
 */
public class DefaultWindGustDirectionUpdatedPropertyEvent implements DevicePropertyEvent, WindGustDirectionUpdatedEvent {
   ...
   */
  public DefaultWindGustDirectionUpdatedPropertyEvent(DevicePropertyId devicePropertyId,
