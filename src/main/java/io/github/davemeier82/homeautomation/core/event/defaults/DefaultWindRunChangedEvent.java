...
public class DefaultWindRunChangedEvent extends AbstractDevicePropertyEvent<Double> implements WindRunChangedEvent {

  public DefaultWindRunChangedEvent(DevicePropertyId devicePropertyId,
                                    String displayName,
