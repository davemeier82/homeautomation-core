...
public class DefaultWindGustSpeedValueUpdateService extends AbstractValueUpdateService<Float> implements WindGustSpeedValueUpdateService {

  private final EventFactory eventFactory;

  public DefaultWindGustSpeedValueUpdateService(DevicePropertyValueRepository devicePropertyValueRepository,
  ...
  protected DevicePropertyEvent<Float> createUpdatedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Float> newValue, DataWithTimestamp<Float> previousValue, String displayName) {
    return eventFactory.createWindGustSpeedUpdatedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
  ...
  protected DevicePropertyEvent<Float> createChangedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Float> newValue, DataWithTimestamp<Float> previousValue, String displayName) {
    return eventFactory.createWindGustSpeedChangedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
