 ...
 * @since 0.3.0
 */
public class DefaultSmokeStateChangedPropertyEvent implements DevicePropertyEvent, SmokeStateChangedEvent {
   ...
   */
  public DefaultSmokeStateChangedPropertyEvent(DevicePropertyId devicePropertyId,
                                               String displayName,
