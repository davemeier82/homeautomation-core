...
/**
 * Default implementation of a {@link SmokeStateChangedEvent}.
 *
 * @author David Meier
 * @since 0.3.0
 */
public class DefaultSmokeStateChangedPropertyEvent extends DevicePropertyEventBase<SmokeSensor> implements SmokeStateChangedEvent {
   ...
   */
  public DefaultSmokeStateChangedPropertyEvent(SmokeSensor smokeSensor,
  ...
  @Override
  public DataWithTimestamp<Boolean> isSmokeDetected() {
    return isActive;
  }
  ...
  public String getMessageKey() {
    return isActive.getValue() ? "smokeDetected" : "smokeStopped";
  }
