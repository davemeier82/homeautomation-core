...
public class DefaultWindGustSpeedChangedEvent extends AbstractDevicePropertyEvent<Float> implements WindGustSpeedChangedEvent {

  public DefaultWindGustSpeedChangedEvent(DevicePropertyId devicePropertyId,
                                          String displayName,
