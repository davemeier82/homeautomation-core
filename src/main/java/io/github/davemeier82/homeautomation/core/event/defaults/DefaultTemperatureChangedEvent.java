...
public class DefaultTemperatureChangedEvent extends AbstractDevicePropertyEvent<Float> implements TemperatureChangedEvent {

  public DefaultTemperatureChangedEvent(DevicePropertyId devicePropertyId,
                                        String displayName,
