...
public class DefaultLightningDistanceValueUpdateService extends AbstractValueUpdateService<Integer> implements LightningDistanceValueUpdateService {

  private final EventFactory eventFactory;

  public DefaultLightningDistanceValueUpdateService(DevicePropertyValueRepository devicePropertyValueRepository,
  ...
  protected DevicePropertyEvent<Integer> createUpdatedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Integer> newValue, DataWithTimestamp<Integer> previousValue, String displayName) {
    return eventFactory.createLightningDistanceUpdatedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
  ...
  protected DevicePropertyEvent<Integer> createChangedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Integer> newValue, DataWithTimestamp<Integer> previousValue, String displayName) {
    return eventFactory.createLightningDistanceChangedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
