...
public class DefaultRainIntervalValueUpdateService extends AbstractValueUpdateService<Float> implements RainIntervalValueUpdateService {

  private final EventFactory eventFactory;

  public DefaultRainIntervalValueUpdateService(DevicePropertyValueRepository devicePropertyValueRepository,
  ...
  protected DevicePropertyEvent<Float> createUpdatedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Float> newValue, DataWithTimestamp<Float> previousValue, String displayName) {
    return eventFactory.createRainIntervalAmountUpdatedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
  ...
  protected DevicePropertyEvent<Float> createChangedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Float> newValue, DataWithTimestamp<Float> previousValue, String displayName) {
    return eventFactory.createRainIntervalAmountChangedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
