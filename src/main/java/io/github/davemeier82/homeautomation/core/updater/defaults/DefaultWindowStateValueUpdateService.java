...
public class DefaultWindowStateValueUpdateService extends AbstractValueUpdateService<Boolean> implements WindowStateValueUpdateService {

  private final EventFactory eventFactory;

  public DefaultWindowStateValueUpdateService(DevicePropertyValueRepository devicePropertyValueRepository,
  ...
  protected DevicePropertyType getDevicePropertyType() {
    return DefaultDevicePropertyType.WINDOW_SENSOR;
  }
  ...
  protected DevicePropertyEvent<Boolean> createUpdatedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Boolean> newValue, DataWithTimestamp<Boolean> previousValue, String displayName) {
    return eventFactory.createWindowStateUpdatedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
  ...
  protected DevicePropertyEvent<Boolean> createChangedEvent(DevicePropertyId devicePropertyId, DataWithTimestamp<Boolean> newValue, DataWithTimestamp<Boolean> previousValue, String displayName) {
    return eventFactory.createWindowStateChangedEvent(devicePropertyId, newValue, previousValue, displayName);
  }
