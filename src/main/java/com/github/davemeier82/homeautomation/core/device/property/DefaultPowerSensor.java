...
public class DefaultPowerSensor implements PowerSensor {
  ...
  public void setWatt(double watt) {
    DataWithTimestamp<Double> newValue = new DataWithTimestamp<>(watt);
    DataWithTimestamp<Double> previousValue = this.watt.getAndSet(newValue);
    if (previousValue == null || !previousValue.getValue().equals(watt)) {
